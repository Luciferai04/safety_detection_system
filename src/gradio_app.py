...
⚠️ **Critical Violations:** {len(analysis.get('critical_violations', []))}
...
⏱️ **Processing Time:** {results.get('processing_time', 0):.3f} seconds
🖥️ **Device:** {results.get('device', 'Unknown')}
"""
    ...
    with gr.Blocks(
        ...
        **Features:**
        ...
        with gr.Tabs():
            ...
            with gr.Tab("📽️ Video Analysis", id="video_analysis"):
            ...
            with gr.Tab("ℹ️ System Info", id="system_info"):
...
- ⚠️ Violations are automatically detected and reported
...
**🦺 Safety Detection System v2.0** | Built with ❤️ for thermal power plant safety
